#ifndef PROCMETRIX_MEM_LINUX_INTERNAL_H
#define PROCMETRIX_MEM_LINUX_INTERNAL_H
...
extern "C"
{
    ...
    //! Reads swap memory from /proc/meminfo
    //! @private
    PROCMETRIX_API procmetrix_error_t procmetrix_impl_linux_system_swap_memory(FILE *meminfo_file, FILE *vmstat_file, procmetrix_swap_memory_t *swap_memory);
